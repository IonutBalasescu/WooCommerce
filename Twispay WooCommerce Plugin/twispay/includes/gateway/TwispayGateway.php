    ...
    public function __construct() {
        ...
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type'     => 'checkbox',
                'label'    => esc_html__( $translator->('ws_enable_disable_label'), 'woocommerce' ),
                'default'  => 'yes'
            ),
            'title' => array(
                'title'        => esc_html__( $translator->('ws_title_title'), 'woocommerce' ),
                'type'         => 'text',
                'description'  => esc_html__( $translator->('ws_title_desc'), 'woocommerce' ),
                'default'      => esc_html__( 'Twispay', 'woocommerce' ),
                'desc_tip'     => true
            ),
            'description' => array(
                'title'        => esc_html__( $translator->('ws_description_title'), 'woocommerce' ),
                'type'         => 'textarea',
                'description'  => esc_html__( $translator->('ws_description_desc'), 'woocommerce' ),
                'default'      => esc_html__( $translator->('ws_description_default'), 'woocommerce' ),
                'desc_tip'     => true
            ),
            'live_mode' => array(
            ...
            'enable_for_methods' => array(
                'title'              => esc_html__( $translator->('ws_enable_methods_title'), 'woocommerce' ),
                'type'               => 'multiselect',
                'class'              => 'wc-enhanced-select',
                'css'                => 'width: 400px;',
                'default'            => '',
                'description'        => esc_html__( $translator->('ws_enable_methods_desc'), 'woocommerce' ),
                'options'            => $shipping_methods,
                'desc_tip'           => true,
                'custom_attributes'  => array(
                    'data-placeholder'  => esc_html__( $translator->('ws_enable_methods_placeholder'), 'woocommerce' ),
                ),
            ),
            'enable_for_virtual' => array(
                'title'    => esc_html__( $translator->('ws_vorder_title'), 'woocommerce' ),
                'label'    => esc_html__( $translator->('ws_vorder_desc'), 'woocommerce' ),
                'type'     => 'checkbox',
                'default'  => 'yes',
            )
        );
